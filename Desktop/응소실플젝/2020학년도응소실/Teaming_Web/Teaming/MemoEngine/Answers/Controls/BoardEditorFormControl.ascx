    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <h2 class="text-center">아이디어 작성하기</h2>
                <h4><%= Message %></h4>
                ...
                <table style="width: 700px; border-collapse: collapse; padding: 5px; margin-left: auto; margin-right: auto;">
                    ...
                    <tr>
                        ...
                        <td style="width: 500px;">
                            <asp:DropDownList ID="ddlCategoryList" runat="server" CssClass="form-control" Width="150px">
                                <asp:ListItem Text="프로그래밍" Value="Coding"></asp:ListItem>
                                <asp:ListItem Text="생활" Value="Life"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="valEmail2" runat="server"
                                ErrorMessage="* 메일 주소를 작성해 주세요."
                                ControlToValidate="txtEmail" Display="None"
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
